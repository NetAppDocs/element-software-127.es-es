...
Puede aplicar una política de calidad de servicio a los volúmenes de almacenamiento existentes mediante Cloud Control de NetApp. Si, en cambio, necesita establecer valores de calidad de servicio personalizados para un volumen, <<Editar un volumen>>puede . Para crear una nueva política de calidad de servicio, consulte link:task-hcc-qos-policies.html["Cree y gestione políticas de calidad de servicio de volúmenes"^].
