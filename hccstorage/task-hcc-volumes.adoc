...
+
Consulte la información sobre link:../concepts/concept_solidfire_concepts_volume_access_groups.html["los grupos de acceso de volúmenes"].
...
+
Consulte la información sobre link:../concepts/concept_solidfire_concepts_accounts_and_permissions.html#user-accounts["Cuentas de usuario del sistema de almacenamiento all-flash SolidFire"].
...
+
Consulte la información sobre link:../concepts/concept_data_manage_volumes_solidfire_quality_of_service.html#qos-performance.html["Políticas de rendimiento y calidad de servicio"].
