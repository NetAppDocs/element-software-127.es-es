...
Para más información, consulta https://www.netapp.com/pdf.html?item=/media/10607-tr4741.pdf["TR-4741: Replicación remota del software NetApp Element"^].
...
Consulta https://www.netapp.com/pdf.html?item=/media/19771-tr-4651.pdf["TR-4651: Arquitectura y configuración de SnapMirror para SolidFire de NetApp"^].
...
[[custompdcustom-protection-domains]]
== [[custom_pd]]Dominios de protección personalizados
