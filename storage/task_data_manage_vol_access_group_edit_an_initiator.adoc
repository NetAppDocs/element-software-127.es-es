...
Para añadir un nombre de cuenta CHAP y credenciales por iniciador, debe usar `ModifyInitiator` la llamada API para quitar y añadir atributos y acceso CHAP.
