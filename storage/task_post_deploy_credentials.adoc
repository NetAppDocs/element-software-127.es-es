...
* Actualice las credenciales de administrador del clúster de almacenamiento en mnode con el link:../api/reference_element_api_modifyclusteradmin.html["API modifyclusteradmin"].
...
En implementaciones de NetApp HCI,  el usuario especificó el nombre de usuario y la contraseña durante la instalación inicial de ese nodo de computación en el motor de puesta en marcha de NetApp.
