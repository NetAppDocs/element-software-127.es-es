...
Hay tipos de acceso disponibles a través de la API que no están disponibles en la interfaz de usuario de Element.
...
* link:../api/reference_element_api_app_b_access_control.html["Infórmate sobre los tipos de acceso disponibles para las Element APIs"]
* link:task_system_manage_enable_ldap_authentication.html["Habilite la autenticación de LDAP con la interfaz de usuario de Element"]
* link:concept_system_manage_manage_ldap.html["Desactive LDAP"]
