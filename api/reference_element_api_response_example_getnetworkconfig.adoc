...
summary: El método GetNetworkConfig devuelve una respuesta similar al ejemplo siguiente. 
---
= GetNetworkConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
 `GetNetworkConfig`El método devuelve una respuesta similar a la del siguiente ejemplo.
