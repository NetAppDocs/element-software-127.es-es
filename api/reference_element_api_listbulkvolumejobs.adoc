...
[role="lead"]
Es posible usar el `ListBulkVolumeJobs` método para obtener información acerca de cada operación de lectura o escritura masiva de volumen que tiene lugar en el sistema.
