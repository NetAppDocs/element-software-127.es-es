...
[role="lead"]
Puede usar el `GetNodeActiveTlsCiphers` método en un solo nodo para obtener una lista de los cifrados TLS que se han aceptado actualmente en este nodo. Puede usar este método para los nodos de almacenamiento y de gestión.
