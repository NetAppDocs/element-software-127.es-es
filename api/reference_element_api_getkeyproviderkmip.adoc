...
[role="lead"]
Es posible usar `GetKeyProviderKmip` el método para recuperar información sobre el proveedor de claves del protocolo de interoperabilidad de gestión de claves (KMIP) especificado.
