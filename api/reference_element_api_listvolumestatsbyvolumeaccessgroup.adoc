...
[role="lead"]
Puede usar el `ListVolumeStatsByVolumeAccessGroup` método para mostrar las mediciones de actividad totales de todos los volúmenes miembros de los grupos de acceso de volúmenes especificados.
