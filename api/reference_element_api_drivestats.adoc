...
[role="lead"]
El objeto driveStats contiene mediciones de actividad de alto nivel para una sola unidad. Puede recuperar la información de medición con el método API `GetDriveStats` .
