...
[role="lead"]
Es posible utilizar `SetLldpConfig` el método para configurar las opciones del protocolo de detección de nivel de vínculo (LLDP) para un clúster de almacenamiento.
