...
[role="lead"]
Puede utilizar el `CreateQoSPolicy` método para crear un objeto QoSPolicy que más adelante puede aplicar a un volumen tras su creación o modificación. Una política de calidad de servicio tiene un ID único, un nombre y una configuración de calidad de servicio.
