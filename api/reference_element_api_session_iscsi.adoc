...
[role="lead"]
El objeto Session (iSCSI) contiene información detallada sobre la sesión iSCSI de cada volumen. Se puede recuperar información de la sesión iSCSI con el `ListISCSISessions` método API.
