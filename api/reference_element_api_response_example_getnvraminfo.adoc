...
summary: El método GetNvramInfo devuelve una respuesta similar al ejemplo siguiente. 
---
= GetNvramInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
 `GetNvramInfo`El método devuelve una respuesta similar a la del siguiente ejemplo.
