...
[role="lead"]
Puede utilizar el `GetHardwareInfo` método para obtener información y estado de hardware activos para un solo nodo. La información de hardware suele incluir a los fabricantes, proveedores, versiones, unidades y otra información de identificación asociada.
