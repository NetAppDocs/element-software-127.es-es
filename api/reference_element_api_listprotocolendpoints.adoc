...
[role="lead"]
Puede usar el `ListProtocolEndpoints` método para recuperar información sobre todos los extremos de protocolo del clúster. Los extremos de protocolo rigen el acceso a sus contenedores de almacenamiento de volúmenes virtuales asociados.
