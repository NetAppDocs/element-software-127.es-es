...
[role="lead"]
Puede usar el `ModifyVolumePair` método para pausar o reiniciar la replicación entre una pareja de volúmenes. Este método se establece en el volumen de origen (el volumen con acceso de lectura/escritura).
