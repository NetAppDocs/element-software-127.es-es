...
[role="lead"]
Puede usar el `EnableMaintenanceMode` método para preparar un nodo de almacenamiento para su mantenimiento. Los escenarios de mantenimiento incluyen cualquier tarea que requiera que el nodo se apague o se reinicie.
