...
[role="lead"]
Puede usar `ListAccounts` para obtener la lista completa de cuentas de inquilinos de almacenamiento, con soporte de paginación opcional. Las cuentas de Element permiten el acceso a los volúmenes.
