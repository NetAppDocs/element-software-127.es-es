...
[role="lead"]
La interfaz de usuario web del software Element utiliza `ModifySnapMirrorEndpoint` el método para cambiar el nombre y los atributos de gestión de un extremo de SnapMirror.
