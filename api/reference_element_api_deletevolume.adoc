...
[role="lead"]
Puede usar el `DeleteVolume` método para marcar un volumen activo para su eliminación. Una vez marcado, el volumen se purga (se elimina permanentemente) después de que transcurre un intervalo de limpieza.
