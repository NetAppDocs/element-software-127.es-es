...
[role="lead"]
Puede usar `GetFipsReport` el método para comprobar el estado de compatibilidad de la función de cifrado FIPS 140-2 de todos los nodos del clúster de almacenamiento.
