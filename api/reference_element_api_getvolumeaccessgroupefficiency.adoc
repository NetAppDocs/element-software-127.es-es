...
[role="lead"]
Puede usar el `GetVolumeAccessGroupEfficiency` método para obtener información de eficiencia acerca de un grupo de acceso de volúmenes. Solo el grupo de acceso de volúmenes que se proporciona como parámetro en este método de API se utiliza para calcular la capacidad.
