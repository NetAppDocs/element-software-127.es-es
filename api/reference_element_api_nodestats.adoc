...
[role="lead"]
El objeto nodeStats contiene mediciones de actividad de alto nivel para un nodo. Puede utilizar `GetNodeStats` los métodos y `ListNodeStats` API para obtener algunos o todos los objetos nodeStats.
