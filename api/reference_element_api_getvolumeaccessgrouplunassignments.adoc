...
[role="lead"]
Es posible utilizar el `GetVolumeAccessGroupLunAssignments` método para recuperar detalles de las asignaciones de LUN de un grupo de acceso de volúmenes especificado.
