...
[role="lead"]
Puede usar el `DeleteQoSPolicy` método para eliminar una política de calidad de servicio del sistema. La configuración de calidad de servicio de todos los volúmenes creados o modificados con esta política no se ve afectada.
