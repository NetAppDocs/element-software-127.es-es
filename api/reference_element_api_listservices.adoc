...
[role="lead"]
Puede usar el `ListServices` método para incluir información de servicios para nodos, unidades, software actual y otros servicios que se estén ejecutando en el clúster.
