...
[role="lead"]
El objeto FiberChannelPort contiene información acerca de los puertos individuales de un nodo o de un nodo entero del clúster. Puede recuperar esta información mediante el `ListNodeFibreChannelPortInfo` método.
