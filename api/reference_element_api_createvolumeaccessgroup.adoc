...
[role="lead"]
Es posible usar `CreateVolumeAccessGroup` para crear un grupo de acceso de volúmenes nuevo. Al crear el grupo de acceso de volúmenes, es necesario asignarle un nombre y de manera opcional se pueden introducir iniciadores y volúmenes.
