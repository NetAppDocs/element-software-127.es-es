...
[role="lead"]
El objeto fipsReport contiene información acerca de la compatibilidad con FIPS 140-2 para todos los nodos del clúster de almacenamiento. Puede recuperar esta información mediante el `GetFipsReport` método.
