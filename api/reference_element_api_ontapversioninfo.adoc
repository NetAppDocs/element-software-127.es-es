...
[role="lead"]
El objeto ontapVersionInfo contiene información acerca de la versión API del clúster ONTAP en una relación de SnapMirror. La interfaz de usuario web de Element utiliza `GetOntapVersionInfo` el método API para obtener esta información.
