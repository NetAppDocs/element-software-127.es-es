...
[role="lead"]
Puede usar `RemoveSSLCertificate` el método para quitar el certificado SSL de usuario y la clave privada de los nodos de almacenamiento del clúster. Después de eliminar el certificado y la clave privada, los nodos de almacenamiento se configuran para usar el certificado predeterminado y la clave privada.
