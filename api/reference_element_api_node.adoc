...
[role="lead"]
El objeto del nodo contiene información acerca de cada nodo del clúster. Puede recuperar esta información mediante los `ListActiveNodes` métodos y. `ListAllNodes`
