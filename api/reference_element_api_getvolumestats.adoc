...
[role="lead"]
Puede utilizar el `GetVolumeStats` método para obtener mediciones de actividad de alto nivel para un solo volumen. Los valores se acumulan a partir de la creación del volumen.
