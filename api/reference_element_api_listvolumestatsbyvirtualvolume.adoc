...
[role="lead"]
Puede usar el `ListVolumeStatsByVirtualVolume` método para mostrar las estadísticas de volúmenes de cualquier volumen del sistema que estén asociados con el volumen virtual. Las estadísticas se acumulan a partir de la creación del volumen.
