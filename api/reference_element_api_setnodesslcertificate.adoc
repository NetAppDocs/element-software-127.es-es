...
summary: Puede usar el método SetNodeSSLCertificate para establecer un certificado SSL de usuario y una clave privada para el nodo de gestión. 
---
...
[role="lead"]
Es posible usar `SetNodeSSLCertificate` el método para configurar un certificado SSL de usuario y una clave privada para el nodo de gestión.
