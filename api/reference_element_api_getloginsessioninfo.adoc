...
[role="lead"]
Puede utilizar `GetLoginSessionInfo` el método para obtener el período de tiempo que una sesión de autenticación de inicio de sesión es válida tanto para los shell de inicio de sesión como para la TUI.
