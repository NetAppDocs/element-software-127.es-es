...
[role="lead"]
El objeto fipsErrorNodeReport contiene información de error para cada nodo que no responde con información sobre la compatibilidad con FIPS 140-2 cuando se lo consulta con el `GetFipsReport` método.
