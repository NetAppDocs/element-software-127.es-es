...
summary: El método GetClusterHardwareInfo devuelve una respuesta similar al siguiente ejemplo. 
---
...
[role="lead"]
 `GetClusterHardwareInfo`El método devuelve una respuesta similar a la del siguiente ejemplo.
