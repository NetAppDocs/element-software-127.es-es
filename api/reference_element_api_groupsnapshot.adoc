...
[role="lead"]
El objeto groupSnapshot contiene información sobre una snapshot de un grupo de volúmenes. Se puede usar `ListGroupSnapshots` el método API para recuperar información Snapshot del grupo.
