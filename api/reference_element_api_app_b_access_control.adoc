...
NOTE: Hay tipos de acceso disponibles a través de la API que no están disponibles en la interfaz de usuario de Element.
...
link:../storage/concept_system_manage_manage_cluster_administrator_users.html#view-cluster-admin-details["Descubre los tipos de acceso disponibles en la Element UI"]
