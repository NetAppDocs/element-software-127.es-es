...
[role="lead"]
La interfaz de usuario web del software Element usa el `ListSnapMirrorSchedules` método para obtener una lista de las programaciones disponibles en un clúster de ONTAP remoto.
