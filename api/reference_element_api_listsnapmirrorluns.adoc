...
[role="lead"]
La interfaz de usuario web del software Element usa `ListSnapMirrorLuns` el método para mostrar la información de LUN para la relación de SnapMirror desde el clúster de ONTAP remoto.
