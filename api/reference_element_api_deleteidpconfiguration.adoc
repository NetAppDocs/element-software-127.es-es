...
[role="lead"]
Es posible usar el `DeleteIdpConfiguration` método para eliminar una configuración existente de un IdP de terceros para el clúster. Al eliminar la última configuración de IDP, se quita el certificado de proveedor de servicios SAML del clúster.
