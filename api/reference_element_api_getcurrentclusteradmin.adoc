...
[role="lead"]
Puede usar el `GetCurrentClusterAdmin` método para mostrar información del administrador del clúster principal actual El administrador de clúster principal se creó cuando se creó el clúster.
