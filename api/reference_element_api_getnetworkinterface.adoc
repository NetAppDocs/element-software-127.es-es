...
[role="lead"]
Puede usar el `GetNetworkInterface` método para obtener información acerca de una interfaz de red en un nodo.
...
* Resultado: (xref:reference_element_api_networkinterface.adoc[NetworkInterface]) Información de configuración de interfaz para este nodo de almacenamiento.
