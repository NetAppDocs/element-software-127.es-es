...
[role="lead"]
Puede usar el `DisableBmcColdReset` método para deshabilitar la tarea en segundo plano que restablece periódicamente la controladora de administración de placa base (BMC) para todos los nodos del clúster.
