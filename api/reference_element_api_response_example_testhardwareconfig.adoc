...
summary: El método TestHardwarConfig devuelve una respuesta similar al ejemplo siguiente. 
---
= TestHardwarConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
 `TestHardwareConfig`El método devuelve una respuesta similar a la del siguiente ejemplo.
