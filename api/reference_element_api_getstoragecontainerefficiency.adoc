...
[role="lead"]
Se puede usar el `GetStorageContainerEfficiency` método para recuperar información de eficiencia acerca de un contenedor de almacenamiento del volumen virtual.
