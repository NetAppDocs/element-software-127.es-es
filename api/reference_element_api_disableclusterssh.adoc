...
[role="lead"]
Puede usar `DisableClusterSsh` el método para deshabilitar el servicio SSH para todo el clúster de almacenamiento. Cuando añada nodos al clúster de almacenamiento, los nuevos nodos heredan esta configuración en todo el clúster.
