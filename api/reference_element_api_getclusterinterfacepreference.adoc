...
[role="lead"]
El `GetClusterInterfacePreference` método permite que los sistemas integrados con clústeres de almacenamiento que ejecutan el software Element obtengan información sobre una preferencia de interfaz de clúster existente. Este método es para uso interno.
