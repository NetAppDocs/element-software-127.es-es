...
[role="lead"]
El objeto volumeAccessGroup contiene información sobre un grupo de acceso de volúmenes específico. Puede recuperar una lista de esta información para todos los grupos de acceso con el método API `ListVolumeAccessGroups` .
