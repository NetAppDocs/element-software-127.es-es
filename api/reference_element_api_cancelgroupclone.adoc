...
[role="lead"]
Es posible usar el `CancelGroupClone` método para detener un proceso de clonado continuo que se produce en un grupo de volúmenes. Cuando se cancela una operación de clonado de grupo, el sistema completa y elimina la operación establish asociada a la operación.
