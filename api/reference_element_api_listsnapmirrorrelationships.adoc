...
[role="lead"]
La interfaz de usuario web del software Element usa el `ListSnapMirrorRelationships` método para enumerar una o todas las relaciones de SnapMirror en un clúster de almacenamiento de Element.
