...
[role="lead"]
Es posible usar el `TestDrives` método para ejecutar una validación de hardware en todas las unidades del nodo. Este método detecta fallos de hardware en las unidades e informa de cualquiera de los resultados de las pruebas de validación.



== Parámetros

Solo puede usar el `TestDrives` método en nodos que no estén «activos» en un clúster.
