...
[role="lead"]
El objeto hardwareInfo contiene información detallada sobre el hardware y el estado de cada nodo del clúster. Puede recuperar esta información con el `GetHardwareInfo` método API.
