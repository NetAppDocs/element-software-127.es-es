...
[role="lead"]
La interfaz de usuario web del software Element usa `ListSnapMirrorVservers` el método para mostrar todos los vServers SnapMirror que están disponibles en un sistema ONTAP remoto.
