...
[role="lead"]
La interfaz de usuario web del software Element usa `ListSnapMirrorAggregates` el método para mostrar todos los agregados de SnapMirror que están disponibles en el sistema ONTAP remoto. Un agregado describe un conjunto de recursos de almacenamiento físicos.
