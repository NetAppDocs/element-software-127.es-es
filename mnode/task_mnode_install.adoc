...
.Pasos
. Descargue el OVA o ISO para la instalación desde link:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Software Element"^]la página del sitio de soporte de NetApp. El nuevo OVA contiene un certificado SSL actualizado.
+
